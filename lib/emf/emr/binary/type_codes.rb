...
module Emf
  module Emr
    module Binary
      # EMR record type codes (subset; full list per MS-EMF 2.3.1).
      # Adding a new record type = adding one constant here, one entry in
      # TYPE_TO_NAME in records.rb, and one wire class file in records/.
      module TypeCodes
        HEADER                = 1
        POLYBEZIER            = 2
        POLYGON               = 3
